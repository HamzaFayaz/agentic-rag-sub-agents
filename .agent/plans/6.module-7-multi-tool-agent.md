...
- [x] **P0** Shared foundation (config, env, tool contracts)
- [x] **A** Text-to-SQL (views, validator, service, executor)
- [x] **B** Web search (Tavily service, executor)
- [x] **C** Tool infra (RAG wrapper, dispatcher)
- [x] **D** Frontend (SSE, attribution UI, ChatPage)
- [x] **G1** All tool executors ready
- [x] **E** Agent loop + SSE integration
- [x] **G2** E2E validation (routing + SQL boundary tests) — *automated tests passed; full E2E re-test optional — see PROGRESS.md*
- [x] **F** LangSmith + docs
