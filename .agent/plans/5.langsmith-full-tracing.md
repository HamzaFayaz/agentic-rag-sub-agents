...
- [ ] **P0** Tracing helper + config flag
- [ ] **P1** `chat_turn` + `rag_retrieve`
- [ ] **P2** `hybrid_rrf` + `cohere_rerank`
- [ ] **P3** `build_rag_prompt`
- [ ] **P4** `document_ingest` + `metadata_extract`
- [ ] **P5** `embed_texts` (optional)
- [ ] **P6** README, `.env.example`, PROGRESS
